...
public class FitniumCheckBoxAPI {
    ...
    */
    public final static void setCheckBoxToState ( FitniumFixture fitnium, String loc, String state ) {
    ...
    */
    public final static void setCheckBoxToClick ( FitniumFixture fitnium, String loc, String state ) {
        String actualState = FitniumVariableAPI.replaceAnyVars(state);
    ...
    */
    public final static void clickCheckBox ( FitniumFixture fitnium, String loc ) {
    	fitnium.getSelenium().check( FitniumVariableAPI.replaceAnyVars(loc) );
    }
     ...
     */
    public final static void unclickCheckBox ( FitniumFixture fitnium, String loc ) {
    	fitnium.getSelenium().uncheck( FitniumVariableAPI.replaceAnyVars(loc) );
    }
     ...
     */
    public final static boolean isCheckBoxChecked ( FitniumFixture fitnium, String loc ) {
     ...
     */
    public final static void storeIsCheckBoxCheckedIn ( FitniumFixture fitnium, String loc, String name ) {
